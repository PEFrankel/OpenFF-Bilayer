...
def plotOrderParameters(OPsim, OPsim2, OPexp):
    """:meta private:"""
    xValuesHG = []
    xValuesSN1 = []
    xValuesSN2 = []
    ...
    if (len(OPsim2) != 0):
        plt.errorbar(xValuesHG,yValuesHGsim2, yerr = yValuesHGsim2ERR,fmt='.',color='blue',markersize=20)
    ...
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN1,yValuesSN1sim2,color='blue')
        plt.errorbar(xValuesSN1,yValuesSN1sim2, yerr = yValuesSN1sim2ERR,fmt='.',color='blue',markersize=25)
    if (len(OPexp) != 0):
    ...
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN2,yValuesSN2sim2,color='blue')
        plt.errorbar(xValuesSN2,yValuesSN2sim2,yValuesSN2sim2ERR,fmt='.',color='blue',markersize=25)       
    if (len(OPexp) != 0):
...
def plotSimulation(ID, ID2, lipid, SIM2, Experimental):
    """
    ...
    plotOrderParameters(OPsim, OPsim2, OPexp)
    #print(OPsim)
    #print(OPsim2)
    #print(OPexp)
