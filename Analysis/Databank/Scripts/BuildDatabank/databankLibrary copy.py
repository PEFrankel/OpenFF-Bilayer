...
def plotOrderParameters(OPsim, OPsim2, OPsim3, OPexp):
    ...
    plt.errorbar(xValuesHG,yValuesHGsim, yerr = yValuesHGsimERR,fmt='.',color='#0333b0',markersize=20)
    if (len(OPexp) != 0):
        plt.errorbar(xValuesHGexp,yValuesHGexp, yerr = 0.02,fmt='.',color='black',markersize=25)
    if (len(OPsim2) != 0):
        plt.errorbar(xValuesHG,yValuesHGsim2, yerr = yValuesHGsim2ERR,fmt='.',color='#ee7f17',markersize=20)
    if (len(OPsim3) != 0):
        plt.errorbar(xValuesHG,yValuesHGsim3, yerr = yValuesHGsim3ERR,fmt='.',color='green',markersize=20)
    ...
    plt.plot(xValuesSN1,yValuesSN1sim,color='#0333b0')
    plt.errorbar(xValuesSN1,yValuesSN1sim, yerr = yValuesSN1simERR,fmt='.',color='#0333b0',markersize=25)
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN1,yValuesSN1sim2,color='#ee7f17')
        plt.errorbar(xValuesSN1,yValuesSN1sim2, yerr = yValuesSN1sim2ERR,fmt='.',color='#ee7f17',markersize=25)
    if (len(OPsim3) != 0):
        plt.plot(xValuesSN1,yValuesSN1sim3,color='green')
        plt.errorbar(xValuesSN1,yValuesSN1sim3, yerr = yValuesSN1sim3ERR,fmt='.',color='green',markersize=25)
    if (len(OPexp) != 0):
    ...
    plt.errorbar(xValuesSN2,yValuesSN2sim,yValuesSN2simERR,fmt='.',color='#0333b0',markersize=25)
    plt.plot(xValuesSN2,yValuesSN2sim,color='#0333b0')
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN2,yValuesSN2sim2,color='#ee7f17')
        plt.errorbar(xValuesSN2,yValuesSN2sim2,yValuesSN2sim2ERR,fmt='.',color='#ee7f17',markersize=25)
    if (len(OPsim3) != 0):
        plt.plot(xValuesSN2,yValuesSN2sim3,color='green')
        plt.errorbar(xValuesSN2,yValuesSN2sim3,yValuesSN2sim3ERR,fmt='.',color='green',markersize=25)         
    if (len(OPexp) != 0):
...
def plotSimulation(ID, ID2, ID3, lipid, SIM2, Experimental):
    ...
    try:
        ...
        plotFormFactor(FFsim,1, 'OpenFF','#0333b0')
        plotFormFactor(FFsim2,1, 'Slipids','#ee7f17')
        plotFormFactor(FFsim3,1, 'MacRog','green')
        if (Experimental == True):
