...
def plotFormFactor(expFormFactor,k,legend,PlotColor):
    ...
    plt.plot(xValues,yValues,label = legend,color=PlotColor,linewidth=4.0, alpha=0.5)
...
def plotOrderParameters(OPsim, OPsim2, OPsim3, OPexp):
    """:meta private:"""
    xValuesHG = []
    xValuesSN1 = []
    xValuesSN2 = []
    ...
    for key in OPsim:
        if 'M_G1C' in key:
            try:
                ...
                if (len(OPsim2) != 0):
                    yValuesSN1sim2.append(float(OPsim2[key][0][0]))
                    yValuesSN1sim2ERR.append(float(OPsim2[key][0][2]))
                if (len(OPsim3) != 0):
                    yValuesSN1sim3.append(float(OPsim3[key][0][0]))
                    yValuesSN1sim3ERR.append(float(OPsim3[key][0][2]))
            except:
                pass
        elif 'M_G2C' in key:
            try:
                ...
                if (len(OPsim2) != 0):
                    yValuesSN2sim2.append(float(OPsim2[key][0][0]))
                    yValuesSN2sim2ERR.append(float(OPsim2[key][0][2]))
                if (len(OPsim3) != 0):
                    yValuesSN2sim3.append(float(OPsim3[key][0][0]))
                    yValuesSN2sim3ERR.append(float(OPsim3[key][0][2]))
            except:
                pass
            ...
            try:
                ...
                if (len(OPsim2) != 0):
                    yValuesHGsim2.append(float(OPsim2[key][0][0]))
                    yValuesHGsim2ERR.append(float(OPsim2[key][0][2]))
                if (len(OPsim3) != 0):
                    yValuesHGsim3.append(float(OPsim3[key][0][0]))
                    yValuesHGsim3ERR.append(float(OPsim3[key][0][2]))
            except:
                pass
    #print(xValues,yValues)
    plt.rc('font', size=15)
    # plt.text(1, .09, 'HG', fontsize=25)
    #plt.plot(xValuesHG,yValuesHGsim,'.',color='red',markersize=15)
    plt.errorbar(xValuesHG,yValuesHGsim, yerr = yValuesHGsimERR,fmt='.',color='#0333b0',markersize=20, alpha=0.5)
    if (len(OPexp) != 0):
        plt.errorbar(xValuesHGexp,yValuesHGexp, yerr = 0.02,fmt='.',color='black',markersize=25)
    if (len(OPsim2) != 0):
        plt.errorbar(xValuesHG,yValuesHGsim2, yerr = yValuesHGsim2ERR,fmt='.',color='#ee7f17',markersize=20, alpha=0.5)
    if (len(OPsim3) != 0):
        plt.errorbar(xValuesHG,yValuesHGsim3, yerr = yValuesHGsim3ERR,fmt='.',color='green',markersize=20, alpha=0.5)
    ...
    plt.plot(xValuesSN1,yValuesSN1sim,color='#0333b0', alpha=0.5)
    plt.errorbar(xValuesSN1,yValuesSN1sim, yerr = yValuesSN1simERR,fmt='.',color='#0333b0',markersize=25, alpha=0.5)
    if (len(OPexp) != 0):
    ...
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN1,yValuesSN1sim2,color='#ee7f17', alpha=0.5)
        plt.errorbar(xValuesSN1,yValuesSN1sim2, yerr = yValuesSN1sim2ERR,fmt='.',color='#ee7f17',markersize=25, alpha=0.5)
    if (len(OPsim3) != 0):
        plt.plot(xValuesSN1,yValuesSN1sim3,color='green', alpha=0.5)
        plt.errorbar(xValuesSN1,yValuesSN1sim3, yerr = yValuesSN1sim3ERR,fmt='.',color='green',markersize=25, alpha=0.5)
    plt.xlabel('Carbon #',size=25)
    plt.ylabel(r'$S_{CH}$',size=25)
    # plt.legend()
    plt.xticks(size=20)
    ...
    plt.errorbar(xValuesSN2,yValuesSN2sim,yValuesSN2simERR,fmt='.',color='#0333b0',markersize=25, alpha=0.5)
    plt.plot(xValuesSN2,yValuesSN2sim,color='#0333b0', alpha=0.5)
    if (len(OPexp) != 0):
    ...
    if (len(OPsim2) != 0):
        plt.plot(xValuesSN2,yValuesSN2sim2,color='#ee7f17', alpha=0.5)
        plt.errorbar(xValuesSN2,yValuesSN2sim2,yValuesSN2sim2ERR,fmt='.',color='#ee7f17',markersize=25, alpha=0.5)
    if (len(OPsim3) != 0):
        plt.plot(xValuesSN2,yValuesSN2sim3,color='green', alpha=0.5)
        plt.errorbar(xValuesSN2,yValuesSN2sim3,yValuesSN2sim3ERR,fmt='.',color='green',markersize=25, alpha=0.5)         
    plt.xlabel('Carbon #',size=25)
    plt.ylabel(r'$S_{CH}$',size=25)
    # plt.legend()
    plt.xticks(size=20)
...
def plotSimulation(ID, ID2, ID3, lipid, SIM2, Experimental):
    """
    ...
    :param lipid: universal molecule name of the lipid
    ...
    for system in systems:
        ...
        if 'ID' in system.keys():
            ...
            if system['ID'] == ID2:
                path2 = DataBankPath + 'Data/Simulations/' + system['path']
            if system['ID'] == ID3:
                path3 = DataBankPath + 'Data/Simulations/' + system['path']
    #lipid = 'POPC'
    ...
    # sim 2
    FFpathSIM2 = path2 + 'FormFactor.json'
    OPpathSIM2 = path2 + lipid + 'OrderParameters.json'
    READMEfilepath2 = path2 + '/README.yaml'
    FFQualityFilePath2 = path2 + '/FormFactorQuality.json'
    # sim3
    FFpathSIM3 = path3 + 'FormFactor.json'
    OPpathSIM3 = path3 + lipid + 'OrderParameters.json'
    READMEfilepath3 = path3 + '/README.yaml'
    FFQualityFilePath3 = path3 + '/FormFactorQuality.json'
    ...
    # sim 2
    # print(OPpathSIM2)
    # Check path assignment is necessary
    if (SIM2 == True):
        with open(OPpathSIM2) as json_file:
            OPsim2 = json.load(json_file)
        with open(OPpathSIM3) as json_file:
            OPsim3 = json.load(json_file)
    ...
    try:
        ...
        with open(FFpathSIM3) as json_file:
            FFsim3 = json.load(json_file)
        plotFormFactor(FFsim,1, 'OpenFF','#0333b0', alpha=0.5)
        plotFormFactor(FFsim2,1, 'Slipids','#ee7f17', alpha=0.5)
        plotFormFactor(FFsim3,1, 'MacRog','green', alpha=0.5)
        if (Experimental == True):
    ...
    plotOrderParameters(OPsim, OPsim2, OPsim3, OPexp)
    #print(OPsim)
    #print(OPsim2)
    #print(OPexp)
